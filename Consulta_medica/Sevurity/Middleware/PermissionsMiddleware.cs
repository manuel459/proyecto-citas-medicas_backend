using Consulta_medica.Sevurity.Services;
...
namespace Consulta_medica.Sevurity.Middleware
{
    public class PermissionsMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context, IUserPermissionService permissionService)
        {
            ...
            var permissionsIdentity = await permissionService.GetUserPermissionsIdentity(cancellationToken);
